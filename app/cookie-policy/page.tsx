...
export const metadata: Metadata = {
  title: "Cookie Policy - PawFinder",
  description: "Learn about how PawFinder uses cookies and similar technologies",
}
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-center mb-8 text-primary">Cookie Policy</h1>

        <div className="prose prose-lg max-w-none">
          <p className="text-muted-foreground">Last Updated: April 1, 2025</p>

          <p>
            This Cookie Policy explains how PawFinder ("we", "us", or "our") uses cookies and similar technologies to
          ...
          <p>
            Cookies set by the website owner (in this case, PawFinder) are called "first-party cookies". Cookies set by
          ...
          <ul className="list-disc pl-5 space-y-1 my-4">
            <li>
              <strong>Session Cookies:</strong> These cookies are temporary and expire once you close your browser. They
              are used to keep you logged in as you navigate through our site.
            </li>
            <li>
              <strong>Security Cookies:</strong> These cookies help identify and prevent security risks. They may be
              used to store your security preferences or to prevent malicious activity.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1 my-4">
            <li>
              <strong>Preference Cookies:</strong> These cookies remember your preferences and settings to enhance your
              experience (e.g., language preferences, location settings).
            </li>
            <li>
          ...
          <ul className="list-disc pl-5 space-y-1 my-4">
            ...
            <li>
              ...
              (e.g., how much time they spend on which pages, which links they choose to click, what users do and don't
              like, etc.) and this enables us to build and maintain our service with user feedback.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1 my-4">
            <li>
              <strong>Facebook Pixel:</strong> We use the Facebook Pixel to deliver targeted advertisements to users who
              have visited our website when they are on Facebook or other platforms operated by Facebook.
            </li>
            <li>
              <strong>Google Ads:</strong> We use Google Ads cookies to track conversions and to retarget users with
              advertisements across the Google advertising network.
            </li>
          </ul>

          <h2 className="text-2xl font-semibold mt-8 mb-4">Other Tracking Technologies</h2>
          <p>
            ...
            visited our website or opened an email that we have sent them. This allows us, for example, to monitor the
            traffic patterns of users from one page within our website to another, to deliver or communicate with
            cookies, to understand whether you have come to our website from an online advertisement displayed on a
            third-party website, to improve site performance, and to measure the success of email marketing campaigns.
